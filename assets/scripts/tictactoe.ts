...
const ttt_create_btn = document.getElementById("tictactoe_create_btn") as HTMLButtonElement
const ttt_join_btn = document.getElementById("tictactoe_join_btn") as HTMLButtonElement

const ttt_code_label = document.getElementById("ttt_code_label") as HTMLParagraphElement

const scoreboard = document.getElementById("scoreboard") as HTMLDivElement

const player1_label = document.getElementById("player1_label") as HTMLParagraphElement
const player1_wins = document.getElementById("player1_wins") as HTMLParagraphElement

const player2_label = document.getElementById("player2_label") as HTMLParagraphElement
const player2_wins = document.getElementById("player2_wins") as HTMLParagraphElement

const ties_label = document.getElementById("ties") as HTMLParagraphElement
ties_label.style.color = "green"

const board_el = document.getElementById("ttt_board") as HTMLDivElement
...
function getWinningCells(lastRow: number, lastCol: number): number[][] {
