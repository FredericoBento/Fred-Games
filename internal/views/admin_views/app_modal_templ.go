...
func AppModal(app app.App) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("</p><button class=\"delete\" aria-label=\"close\"></button></header><section class=\"modal-card-body\"><h1>abc</h1></section><footer class=\"modal-card-foot\"><div class=\"buttons\"><button class=\"button is-success\">Save changes</button> <button class=\"button\">Cancel</button></div></footer></div>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return templ_7745c5c3_Err
